...
export default defineConfig({
  ...
  webServer: {
    ...
    command: 'npm run build && npm run preview -- --port 4232 --strictPort',
    url: 'http://localhost:4232/crypto-lab-mceliece-gate/',
  ...
  use: {
    baseURL: 'http://localhost:4232/crypto-lab-mceliece-gate/',
    colorScheme: 'dark',
  },
});
